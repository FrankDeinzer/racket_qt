...
> Auf **Windows und macOS** muss `qt-shim` nach dem nächsten Pull
> **einmalig neu gebaut** werden — **ein** Rebuild deckt alle vier ab (Linux ist gebaut).
