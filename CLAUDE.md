...
Linux-Streifenbefund erledigt. **Auf Windows/macOS noch nicht gegengeprüft.** Offen
bleibt aus diesem Cluster nur der Colors-Tab (Fall 2, §25.2, `'(auto-vscroll)`-Panels
mit echten Kind-Widgets — bewusst ausgeklammert, braucht ein eigenes Content-Widget);
