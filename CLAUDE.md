...
sind — Root-Cause nicht untersucht, **neuer Backlog-Punkt, eigene künftige
Session.** Details: `docs/HACKING.md` §44.5, `docs/2026-09-18_report-macos.md`.
